...
enum HandoffIdentifier: String {
  case ReceiveOnchain = "com.defichain.app.dfx.bitcoin.receiveonchain"
  case Xpub = "com.defichain.app.dfx.bitcoin.xpub"
  case ViewInBlockExplorer = "com.defichain.app.dfx.bitcoin.blockexplorer"
}
