...
target state to `sell-complete` turns it red, reverting makes it pass again. P17 is still red -
it reaches the sell screen and stops there because the payment-info page never renders in the
in-app browser.
