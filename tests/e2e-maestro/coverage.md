...
produce. That service is now tracked at `scripts/settle-service.mjs`, and
`scripts/e2e/run-maestro.sh` starts and stops it when `SETTLE_KEY` and the local
